...
- **Write your own** â scaffold a mod project with `create-fate-mod`, build it against the `@fate-core/mod-types` / `@fate-core/mod-build` SDK, and live-reload it in the app via Developer Mode. See [docs/MOD_API.md](./docs/MOD_API.md) for the full author guide.
